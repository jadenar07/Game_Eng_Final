...
constexpr char FONTSHEET_FILEPATH[] = "/Users/jadenritchie/Desktop/SDLSimple/SDLSimple/assets/font1.png";
...
void initialise()
{
    ...
    g_levelA = new LevelA(lives);
    g_levelB = new LevelB(lives);
    start_level = new startLevel("Press enter to start", "RUNNNNNN");
    g_levelC = new LevelC(lives);
    win_level = new startLevel("You Won!!!");
    
    g_levels[0] = start_level;
    g_levels[1] = g_levelA;
    g_levels[2] = g_levelB;
    g_levels[3] = g_levelC;
    g_levels[4] = win_level;
...
//    g_effects->start(SHRINK, 2.0f);
    ...
    bgm = Mix_LoadMUS("/Users/jadenritchie/Desktop/SDLSimple/SDLSimple/assets/theme.mp3");
    Mix_PlayMusic(bgm, -1);
